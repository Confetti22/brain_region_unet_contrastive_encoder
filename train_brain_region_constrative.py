...
def parse_args():
    ...
    # === GENERAL === #
    parser.add_argument('-model', type=str, default="recon_smallnet_mse_loss_woreg_256dim",
                                            help='Model name')
...
def train(gpu, args, cfg):
    ...
    # optimizer = torch.optim.Adam(model.parameters(),lr = args.lr_start,weight_decay=1e-6)
