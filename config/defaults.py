...
_C.MODEL.IMAGE_MODEL_CFG = None
_C.MODEL.IMAGE_MODEL_CKPT = None
...
_C.SOLVER.DECAY_LOSS_WEIGHT = False
...
_C.INFERENCE.GET_PC_FEATURE = 'None'
_C.INFERENCE.GET_PATCH_FEATURE = False
